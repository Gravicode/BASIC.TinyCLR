...
namespace GHI.BasicSharp
{
    ...
    public class BasicSharp
    {
        ...
        protected virtual void OnClearScreen(BasicSharp sender)
        {
            if (ClearScreen != null)
                ClearScreen(sender);
        }
        ...
        protected virtual void OnBackColor(BasicSharp sender, Color color)
        {
            if (BackColor != null)
        ...
        protected virtual void OnForeColor(BasicSharp sender, Color color)
        {
            if (ForeColor != null)
        ...
        protected virtual void OnInKey(BasicSharp sender, ref int KeyCode)
        {
            if (InKey != null)
        ...
        protected virtual void OnInput(BasicSharp sender, ref string Text)
        {
            if (Input != null)
        ...
        protected virtual void OnPrint(BasicSharp sender, string value)
        {
            if (Print != null)
                Print(sender, value);
        }
