using GHI.Basic;
using SBASIC.Library.Properties;
using System;
...
namespace SBASIC.Library
{
    public class SBasicEngine
    {
        public Thread BasicProc { get; set; }
        GHI.Basic.SBASIC basic = null;
        CommunicationsBus Bus { get; set; }
        public SBasicEngine(string uartPort, int baudRate=9600)
        {
            ...
            if (basic == null)
            {
                basic = new GHI.Basic.SBASIC();
                basic.Print += Basic_Print;
                basic.ClearScreen += Basic_ClearScreen;
            }
           
        }
        private void Basic_ClearScreen(GHI.Basic.SBASIC sender)
        {
            //do nothing
            Debug.WriteLine("CLEAR SCREEN");
        }

        private void Basic_Print(GHI.Basic.SBASIC sender, string value)
        {
